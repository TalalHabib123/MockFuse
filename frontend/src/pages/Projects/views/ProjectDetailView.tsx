      ...
      <div className="mt-5 grid gap-4">
        ...
        <section className="rounded-2xl border border-(--border) bg-(--card) p-4">
          ...
          <div className="mt-1 text-sm text-(--muted)">
            {isActiveProject
              ? "Current runtime state for the active project."
              : "Archived projects can still be inspected here, but only the active project can run the gateway."}
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              ...
              disabled={!isActiveProject || project.routesCount === 0 || gatewayState === "running"}
            ...
            <button
              ...
              disabled={!isActiveProject || gatewayState !== "running"}
              onClick={() => void onStop()}
            >
              Stop
            </button>
          ...
          {!isActiveProject && (
            <div className="mt-3 text-sm text-(--muted)">
              Restore this project to make it active before starting or stopping the gateway.
            </div>
          )}
        </section>
